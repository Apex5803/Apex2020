...
public class RobotMap {
    public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_MOTOR = 6; // CAN // 0
    public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_ENCODER = 2; // Analog
    public static final int DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR = 7; // CAN //1
    ...
    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_MOTOR = 0; // CAN
    public static final int DRIVETRAIN_BACK_LEFT_ANGLE_ENCODER = 3; // Analog
    public static final int DRIVETRAIN_BACK_LEFT_DRIVE_MOTOR = 1; // CAN //7
